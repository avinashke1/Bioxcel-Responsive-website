		...
		<nav class="navbar navbar-default navbar-inverse navbar-fixed-top" role="navigation">
			...
			<div class="collapse navbar-collapse" id="collapse">
				...
				<!--	<li><a href="#>Contact</a></li> -->
					<li class="active"><a href="http://localhost:8080/registerphp/contact.php">Contact</a></li>
...
<div class="para_1">
<h4 style="color:white;">Contact us for quick home service.</h4>
<p style="color:white;"><b>Avinash Kumar</b>
<br style="color:white;"><b>(+91) 9593988510</b></br>
<br style="color:white;"><b><i>avinashke1@gmail.com</i></b></br>



<header class="row">
		<div class="col-lg-6 col-sm-5">
			<a href="#"><img src="img/contact.png" alt="Wisdom Pets. click for home." class="pull-right img-responsive img-thumbnail"</a>
		</div>
</div>	
