...
<form name = "loginform" method = "POST" action = "connectivity.php">
  ...
  <h4>Password:</h4> <input type = "password" name = "password" required><br>


<button input id = "button" class="button" type = "submit" name = "submit" style="vertical-align:middle"><span>Log in </span></button>
</form> 
